...
class buttons:
    ...
    # async def application_location(location):
    #     keyboard = Keyboard(one_time=True, inline=False)
    #     keyboard.add(Text("Томск", {"cmd": "application_locatiob_t"}), color=KeyboardButtonColor.POSITIVE)
    #     keyboard.row()
    #     keyboard.add(Text("Северск", {"cmd": "application_locatiob_s"}), color=KeyboardButtonColor.POSITIVE)
    #     keyboard.row()
    #     if location == 'r':
    #         keyboard.add(Text("Томский район", {"cmd": "application_locatiob_r"}), color=KeyboardButtonColor.POSITIVE)
    #         keyboard.row()
    #     keyboard.add(Text("Назад", {"cmd": "back"}), color=KeyboardButtonColor.NEGATIVE)
    #     keyboard.add(Text("В главное меню", {"cmd": "menu"}), color=KeyboardButtonColor.PRIMARY)
    #     keyboard = keyboard.get_json()
    ...
    # async def tomsk_events(*args):
    #     keyboard = Keyboard(one_time=True, inline=False)
    #     keyboard.add(Text("Концерт", {"cmd": "event_1"}), color=KeyboardButtonColor.POSITIVE)
    #     keyboard.add(Text("Фестиваль", {"cmd": "event_2"}), color=KeyboardButtonColor.POSITIVE)
    #     keyboard.row()
    #     keyboard.add(Text("Назад", {"cmd": "back_1"}), color=KeyboardButtonColor.NEGATIVE)
    #     keyboard.add(Text("В главное меню", {"cmd": "menu"}), color=KeyboardButtonColor.PRIMARY)
    #     keyboard = keyboard.get_json()
    ...
    # async def tomsk_obl_events(*args):
    #     keyboard = Keyboard(one_time=True, inline=False)
    #     keyboard.add(Text("Фейеврерк", {"cmd": "event_3"}), color=KeyboardButtonColor.POSITIVE)
    #     keyboard.add(Text("Фестиваль", {"cmd": "event_4"}), color=KeyboardButtonColor.POSITIVE)
    #     keyboard.row()
    #     keyboard.add(Text("Назад", {"cmd": "back_1"}), color=KeyboardButtonColor.NEGATIVE)
    #     keyboard.add(Text("В главное меню", {"cmd": "menu"}), color=KeyboardButtonColor.PRIMARY)
    #     keyboard = keyboard.get_json()
    ...
    # async def menu(*args):
    #     keyboard = Keyboard(one_time=True, inline=False)
    #     # keyboard.add(Text("Консультация по услугам", {"cmd": "consultation"}), color=KeyboardButtonColor.POSITIVE)
    #     # keyboard.row()
    #     keyboard.add(Text("Нуну", {"cmd": "url"}), color=KeyboardButtonColor.POSITIVE)
    #     keyboard.row()
    #     keyboard.add(Text("Записаться на приём", {"cmd": "filials"}), color=KeyboardButtonColor.POSITIVE)
    #     keyboard.row()
    #     keyboard.add(Text("Статус готовности", {"cmd": "status"}), color=KeyboardButtonColor.POSITIVE)
    #     keyboard.row()
    #     keyboard.add(Text("Информация о талонах", {"cmd": "information_coupons"}), color=KeyboardButtonColor.POSITIVE)
    #     keyboard.row()
    #     keyboard.add(Text("Режим работы МФЦ", {"cmd": "information_mfc"}), color=KeyboardButtonColor.POSITIVE)
    #     keyboard.row()
    #     keyboard.add(Text("Отмена записи", {"cmd": "delete_coupons"}), color=KeyboardButtonColor.POSITIVE)
    #     keyboard = keyboard.get_json()
    #     return keyboard
